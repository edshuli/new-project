...
app.get('/', async(req, res) => {
    const beer_data = await fetch('https://api.brewerydb.com/v2/beers/?key=659d5c6b8f3d2447f090119e48202fdb')
...
/*app.get('/api/beers', async(req, res) => {
    ...
    const api_url = `https://api.brewerydb.com/v2/{beers}/?key=659d5c6b8f3d2447f090119e48202fdb`;
